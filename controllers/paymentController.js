...
export const buySubscription = catchAsyncError(async (req, res, next) => {
    ...
    const plan_id = process.env.PLAN_ID || "plan_MBL081tkC9kH3H"
...
export const paymentVerification = catchAsyncError(async (req, res, next) => {
    ...
    const { razorpay_signature, razorpay_payment_id, razorpay_signature_id } = req.body
...
export const getRazorpayKey = catchAsyncError(async(req, res, next)=>{
    ...
    res.status(200).json({
        success: true,
        key: process.env.RAZORPLAY_API_KEY,
    })
})
...
export const cancelSubscription = catchAsyncError(async(req, res, next)=>{
    ...
    res.status(200).json({
        ...
        message: refund ? 
                ...
                :"Subscription cancelled, No refud initiated as subscription was cancelled after 7 days",
    })
})