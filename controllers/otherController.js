...
export const contact = catchAsyncError(async (req, res, next) => {
    ...
    const subject = "Contact from enCourse"
    const test = `I am ${name} and my email is ${email}.\n
                    ${message}`;

    await sendEmail(to, subject, test)
...
export const courseRequest = catchAsyncError(async (req, res, next) => {
    ...
    const to = process.env.MY_MAIL
    const subject = "Requesting for a course on enCourse"
    const test = `I am ${name} and my email is ${email}.\n
                    ${course}`;
